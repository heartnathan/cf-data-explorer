...
<template>
  <div class="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 p-4">
    <div class="w-full max-w-md bg-white dark:bg-slate-950 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
      <!-- Header -->
      <div class="p-8 pb-6 text-center border-b border-slate-100 dark:border-slate-800/50">
        <div class="w-16 h-16 mx-auto bg-gradient-to-br from-orange-400 to-amber-600 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-500/30 mb-4 items-center">
          <el-icon :size="32" color="white"><Cloudy /></el-icon>
        </div>
        ...
        <div class="space-y-5">
          ...
          <div>
            <div class="flex items-center justify-between mb-1.5">
              ...
              <a href="https://dash.cloudflare.com/profile/api-tokens" target="_blank" class="text-xs text-orange-500 hover:text-orange-600 font-medium">Get Token &rarr;</a>
            </div>
            <el-input 
              v-model="form.token" 
              type="password" 
              placeholder="Enter your Cloudflare Global or Scoped API Token" 
              size="large"
              show-password
              clearable
              :prefix-icon="'Key'"
